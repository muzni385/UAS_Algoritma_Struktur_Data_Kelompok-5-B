# BST - Binary Search Tree untuk data pesanan (diurutkan berdasarkan ID Pesanan)
...
class BST:
    ...
    def _delete(self, node, id_pesanan):
        ...
        if id_pesanan < node.data['id_pesanan']:
            ...
            berhasil = True
            # kasus 1: node tidak punya anak sama sekali
            if node.left is None and node.right is None:
                return None, berhasil
            # kasus 2: node cuma punya satu anak
    ...
    def _cari_terkecil(self, node):
        # nilai terkecil ada di paling kiri
